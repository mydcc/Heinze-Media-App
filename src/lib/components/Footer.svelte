...
{#key $page.url}
    <footer
        class="bg-bg-footer border-t border-white/10 relative overflow-hidden"
    >
        <!-- Background Elements -->
        <div
        ...
        <div class="container mx-auto px-6 py-20 relative z-10">
            ...
            <div
                class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-16"
            >
                ...
                <div class="lg:col-span-2">
                    ...
                    <p
                        class="text-text-muted text-sm leading-relaxed mb-6 max-w-sm"
                    >
