...
mission:
  tagline: "My Mission"
  title: "The Next Generation <span class='text-accent'>Web</span>"
  text: "I am convinced that the future of digital interaction lies not in flat websites, but in <span class='text-accent font-bold'>three-dimensional, decentralized worlds</span>. My mission is to provide companies and creators with the tools to build their own independent galaxy on the internet—interactive, brand-compliant, and tailored exactly to their business goals."
  benefits:
    - icon: "3D"
